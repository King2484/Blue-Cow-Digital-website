            ...
            <div class="row pt-50">
                <div class="col-xl-10">
                    <div class="hero-content-four" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <h1 class="hero-title-responsive">Professional websites built around your business, backed by SEO
                            and marketing.</h1>
                        <p>Blue Cow Digital delivers a complete done-for-you digital package — a brand-new professional
                            website, full SEO setup, and ongoing marketing. One monthly investment. Real, measurable
                            results.</p>
            ...
            <div class="row px-xl-5 justify-content-between align-items-center">
                <div class="col-xl-4 col-lg-5">
                    <div class="about-circles rmb-55">
                        <div class="circle bgc-primary text-white" data-aos="fade-left" data-aos-duration="1500"
                            data-aos-offset="50">Website Build
                        </div>
                ...
                <div class="col-lg-7" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                    <div class="about-content-four">
                        ...
                        <p>We deliver a full transformation of your online presence — modern, responsive and built entirely
                            around your brand and goals. No templates. No shortcuts. Just a professional website that
                            represents you properly.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="counter-item counter-text-wrap">
                                ...
                                <div class="text">Businesses that trust Blue Cow Digital to grow their online presence.
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
        ...
        <div class="container px-0 bordered-x pt-130 rpt-100 pb-170 rpb-140">
            <div class="testimonials-and-clients bg-white br-10 bordered">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="testimonials-content rmb-55" data-aos="fade-left" data-aos-duration="1500"
                            ...
                            <p>Don't just take our word for it — here's what businesses we've worked with have to say about
                                the results we've delivered.</p>
                ...
                <div class="client-logo-active"
                    style="display:flex;flex-wrap:wrap;justify-content:center;gap:20px 40px;align-items:center;">
                    <div class="client-logo-item" data-aos="flip-up" data-aos-duration="1500" data-aos-offset="50"
                        style="padding:12px 24px;border:1px solid rgba(255,255,255,0.15);border-radius:6px;">
                        <span
                            style="font-weight:600;font-size:14px;letter-spacing:1px;text-transform:uppercase;color:inherit;">Retail</span>
                    </div>
                    <div class="client-logo-item" data-aos="flip-up" data-aos-delay="50" data-aos-duration="1500"
                        data-aos-offset="50"
                        style="padding:12px 24px;border:1px solid rgba(255,255,255,0.15);border-radius:6px;">
                        <span
                            style="font-weight:600;font-size:14px;letter-spacing:1px;text-transform:uppercase;color:inherit;">Hospitality</span>
                    </div>
                    <div class="client-logo-item" data-aos="flip-up" data-aos-delay="100" data-aos-duration="1500"
                        data-aos-offset="50"
                        style="padding:12px 24px;border:1px solid rgba(255,255,255,0.15);border-radius:6px;">
                        <span
                            style="font-weight:600;font-size:14px;letter-spacing:1px;text-transform:uppercase;color:inherit;">Professional
                            Services</span>
                    </div>
                    <div class="client-logo-item" data-aos="flip-up" data-aos-delay="150" data-aos-duration="1500"
                        ...
                        style="padding:12px 24px;border:1px solid rgba(255,255,255,0.15);border-radius:6px;">
                        <span
                            style="font-weight:600;font-size:14px;letter-spacing:1px;text-transform:uppercase;color:inherit;">Health
                            &amp; Wellness</span>
                    </div>
                    <div class="client-logo-item" data-aos="flip-up" data-aos-delay="200" data-aos-duration="1500"
                        ...
                        style="padding:12px 24px;border:1px solid rgba(255,255,255,0.15);border-radius:6px;">
                        <span
                            style="font-weight:600;font-size:14px;letter-spacing:1px;text-transform:uppercase;color:inherit;">Construction</span>
                    </div>
                    <div class="client-logo-item" data-aos="flip-up" data-aos-delay="250" data-aos-duration="1500"
                        data-aos-offset="50"
                        style="padding:12px 24px;border:1px solid rgba(255,255,255,0.15);border-radius:6px;">
                        <span
                            style="font-weight:600;font-size:14px;letter-spacing:1px;text-transform:uppercase;color:inherit;">eCommerce</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="blog-two-area rel z-1">
        <div class="container px-sm-0 bordered-x pt-130 rpt-100">
            ...
            <div class="blog-timeline-item hover-item">
                ...
                <div class="content">
                    <h4><a href="{{ route('blogDetails') }}">How to Craft a Winning Social Media Strategy from Scratch</a>
                    </h4>
                    <div class="hover-content">
                        <div class="text">
                            <p>Web design agency dedicated creating visually up highly functional websites that help
                                businesses out landscape combining creative design</p>
                        </div>
                        <div class="image">
            ...
            <div class="blog-timeline-item hover-item">
                <span class="date"><a href="#"><i class="far fa-calendar-alt"></i>September 15, 2024</a></span>
                <div class="content">
                    <h4><a href="{{ route('blogDetails') }}">The Importance of Responsive Design in Today's Digital
                            Landscape</a></h4>
                    <div class="hover-content">
                        <div class="text">
                            <p>Web design agency dedicated creating visually up highly functional websites that help
            ...
            <div class="blog-timeline-item hover-item">
                <span class="date"><a href="#"><i class="far fa-calendar-alt"></i>September 15, 2024</a></span>
                <div class="content">
                    <h4><a href="{{ route('blogDetails') }}">How to Improve Your Website's Loading Speed Performance</a>
                    </h4>
                    <div class="hover-content">
                        <div class="text">
                            <p>Web design agency dedicated creating visually up highly functional websites that help
            ...
            <div class="blog-timeline-item hover-item">
                <span class="date"><a href="#"><i class="far fa-calendar-alt"></i>September 15, 2024</a></span>
                <div class="content">
                    <h4><a href="{{ route('blogDetails') }}">How to Choose the Right Web Design Agency for Your Business</a>
                    </h4>
                    <div class="hover-content">
                        <div class="text">
                            <p>Web design agency dedicated creating visually up highly functional websites that help
            ...
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-9 col-md-11 text-center" data-aos="zoom-in" data-aos-duration="1500"
                    ...
                    <div class="section-title mx-xl-3 mb-30">
                        ...
                        <p>Website build, SEO, content and marketing — all delivered by Blue Cow Digital for
                            <strong>£979/month</strong>. Currently offering <strong>50% off your first 3 months</strong>.
                            Speak to us today for a free, no-obligation consultation.</p>
                    </div>
